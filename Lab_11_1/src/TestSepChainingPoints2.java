...
class TestSepChainingPoints2 {
	...
	void test_NoCross() throws Exception {
		...
		assertFalse(sep.isCrossRoad(new Point(9, 2, 4)));
		sep.add(new Point(9, 2, 4));
		assertFalse(sep.isCrossRoad(new Point(9, 2, 4)));
	...
	void test_Cross1() throws Exception {
		...
		sep.add(new Point(9, 3, 4));
		sep.add(new Point(3, 4, 2));
		assertTrue(sep.isCrossRoad(p));

		sep = new SepChainingPoints2();
		sep.add(new Point(9, 2, 5));
		sep.add(new Point(3, 4, 2));
		assertTrue(sep.isCrossRoad(p));

		sep = new SepChainingPoints2();
		sep.add(new Point(9, 3, 5));
		sep.add(new Point(3, 4, 2));
		assertTrue(sep.isCrossRoad(p));
		sep.add(new Point(9, 2, 4));
		assertTrue(sep.isCrossRoad(p));
