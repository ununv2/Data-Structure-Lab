...
class CDLinkedListTest {
	...
	void testSwapRangeGeneric() throws Exception {
		...
		DListIterator it = new DListIterator(l1.header);
		it.previous();
		assertEquals(12, it.currentNode.data);
		it.previous();
		assertEquals(4, it.currentNode.data);
		it.previous();
		assertEquals(3, it.currentNode.data);
		it.previous();
		assertEquals(2, it.currentNode.data);
		it.previous();
		assertEquals(7, it.currentNode.data);
		it.previous();
		assertEquals(6, it.currentNode.data);
		it.previous();
		assertEquals(5, it.currentNode.data);
		it.previous();
		assertEquals(11, it.currentNode.data);
		it.previous();
		assertEquals(10, it.currentNode.data);
		it.previous();
		assertEquals(9, it.currentNode.data);
		it.previous();
		assertEquals(8, it.currentNode.data);
		it.previous();
		assertEquals(1, it.currentNode.data);
		it.previous();
