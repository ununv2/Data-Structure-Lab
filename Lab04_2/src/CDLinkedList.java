public class CDLinkedList {
	...
	public void swapRange(Iterator s1, Iterator f1, Iterator s2, Iterator f2) {
		if (s1 == null || f1 == null || s2 == null || f2 == null || !(s1 instanceof DListIterator) || !(f1 instanceof DListIterator) ||!(s2 instanceof DListIterator) || !(f2 instanceof DListIterator))
			{
		        return;
		    }
		DListIterator start1 = (DListIterator) s1;
		DListIterator finish1 = (DListIterator) f1;
		DListIterator start2 = (DListIterator) s2;
		DListIterator finish2 = (DListIterator) f2;
		DListNode startNode1 = start1.currentNode;
		DListNode finishNode1 = finish1.currentNode;
		DListNode startNode2 = start2.currentNode;
		DListNode finishNode2 = finish2.currentNode;
		DListNode s1prev = startNode1.previousNode;
		DListNode s2prev = startNode2.previousNode;
		DListNode f2next = finishNode2.nextNode;
		DListNode f1next = finishNode1.nextNode;
		
		if (f1next == startNode2) {
	     
	        s1prev.nextNode = startNode2;
	        startNode2.previousNode = s1prev;

	        finishNode2.nextNode = startNode1;
	        startNode1.previousNode = finishNode2;

	        finishNode1.nextNode = f2next;
	        if (f2next != null) {
	            f2next.previousNode = finishNode1;
	        }
	    } else {
	        
	        s1prev.nextNode = startNode2;
	        startNode2.previousNode = s1prev;
	        finishNode2.nextNode = f1next;
	        
	        if (f1next != null) {
	            f1next.previousNode = finishNode2;
	        }

	        s2prev.nextNode = startNode1;
	        startNode1.previousNode = s2prev;
